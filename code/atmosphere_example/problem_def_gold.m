...
opt_dist.reg_degree = 4; %increases connectivity of graph
opt_dist.n_degree_graph = opt_dist.nAgents;
opt_dist.obs.rel_perc = 0.05;%0.05*10^(-8);
...
opt_dist.FLAGS.obs_noise_type = 'absolute'; % ('absolute' | 'relative'); %TODO relative doesn't work correctly.
